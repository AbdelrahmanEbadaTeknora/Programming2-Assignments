...
public class StudentGUI extends BaseGUI {
    ...
    private JButton createDashboardButton(String text) {
        ...
        addHoverEffect(button, PRIMARY_COLOR, PRIMARY_COLOR.darker());
    ...
    private JPanel createAddStudentPanel() {
        ...
        addBtn.addActionListener(e -> handleAddStudent(nameField, ageField, genderBox, deptField, gpaField));
    ...
    private void handleAddStudent(JTextField nameField, JTextField ageField,
    ...
    private JPanel createSearchPanel() {
        ...
        searchBtn.addActionListener(e -> handleSearch(searchType, searchField, searchTableModel));
    ...
    private void handleSearch(JComboBox<String> searchType, JTextField searchField, DefaultTableModel searchTableModel) {
    ...
    private JPanel createUpdatePanel() {
        ...
        findBtn.addActionListener(e -> handleFindForUpdate(idField, nameField, ageField, genderBox, deptField, gpaField, updateBtn));

        updateBtn.addActionListener(e -> handleUpdate(idField, nameField, ageField, genderBox, deptField, gpaField, updateBtn));
    ...
    private void handleFindForUpdate(JTextField idField, JTextField nameField, JTextField ageField,
                                     JComboBox<String> genderBox, JTextField deptField, JTextField gpaField, JButton updateBtn) {
        try {
    ...
    private void handleUpdate(JTextField idField, JTextField nameField, JTextField ageField,
                              JComboBox<String> genderBox, JTextField deptField, JTextField gpaField, JButton updateBtn) {
        try {
            int id = Integer.parseInt(idField.getText().trim());
            String name = nameField.getText().trim();
    ...
    private JPanel createDeletePanel() {
        ...
        findBtn.addActionListener(e -> handleFindForDelete(idField, infoArea, deleteBtn, currentId));

        deleteBtn.addActionListener(e -> handleDelete(idField, infoArea, deleteBtn, currentId));
    ...
    private void handleFindForDelete(JTextField idField, JTextArea infoArea, JButton deleteBtn, int[] currentId) {
        try {
            int id = Integer.parseInt(idField.getText().trim());
            student s = manager.searchById(id);
    ...
    private void handleDelete(JTextField idField, JTextArea infoArea, JButton deleteBtn, int[] currentId) {
